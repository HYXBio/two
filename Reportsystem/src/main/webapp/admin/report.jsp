...
<div data-options="region:'center',title:'信息展示'" style="padding:5px;background:#eee;">
    ...
    <div id="tb">
        搜索：
        <input id="type" name="type" class="easyui-combobox" data-options="required:true,editable:false,textField:'text',valueField:'text',url:'../json/reportSearchType.json',width:100" >
        <input id = "report-content" class="easyui-textbox">
        <a class="easyui-linkbutton" iconCls="icon-add" onClick="searchReport()">搜索</a>
    <a class="easyui-linkbutton" iconCls="icon-add" onClick="checkReport()">审核</a>
        <a class="easyui-linkbutton" iconCls="icon-add" onClick="getAll()">重置</a>
...
<script>
    ...
    function getAll(){
        //获取该用户所有信息
        $('#reportList').datagrid({
            url: "/report/getAllReport.action",
            type:"POST"
        });
